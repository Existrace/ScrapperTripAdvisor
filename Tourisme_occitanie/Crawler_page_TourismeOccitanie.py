...
"""
Script qui parcours les pages de Tourisme Occitanie
...
url = "https://www.tourisme-occitanie.com/tous-les-restaurants"
...
path_waitingList = "/home/snourry/Documents/drive-download-20200106T103458Z-001/TourismeOccitanie/links_waitinglist.csv"

# Le chemin des liens des restaurants (Susceptile de changer, à surveiller)
# Attention il faut récupérer le href, pas le text
path_link = 'En savoir plus'
...
try:
    ...
    list_links = browser.find_elements_by_link_text(path_link)
